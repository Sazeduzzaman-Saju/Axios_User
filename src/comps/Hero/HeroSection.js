    ...
    return (
        <div className="relative">
            <img
                ...
                alt=""
            />
            <div className="relative bg-opacity-75 bg-purple-700 border-none ">
                <svg
                ...
                <div className="relative px-4 py-16 overflow-hidden sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20 max-w-screen-xl mx-auto">
                    <div className="flex flex-col items-center justify-between xl:flex-row">
                        <div className="w-full max-w-xl mb-12 xl:mb-0 xl:pr-16 xl:w-7/12">
                            <h1 className="text-5xl font-bold leading-none sm:text-6xl pb-5">All User <span className="text-white">In One</span>Place
                            </h1>
                            <p className="w-2/3 text-justify mb-4 text-base text-gray-200 md:text-lg">
